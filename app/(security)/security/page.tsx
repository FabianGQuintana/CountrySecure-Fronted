...
//           <h1 className="text-4xl font-bold text-white mb-8">Panel De Control</h1>
...
//   const activeVisits = visitPermissions.filter((p) => p.entryTime !== null && p.departureTime === null).length
//   const pendingVisits = visitPermissions.filter((p) => p.entryTime === null).length
