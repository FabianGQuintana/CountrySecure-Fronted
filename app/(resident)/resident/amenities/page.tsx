          ...
          {submitSuccess ? (
            ...
            >
              ...
              <p className="text-gray-600">
                Tu amenity ha sido reservado exitosamente
              </p>
            </motion.div>
          ) : (
            <motion.form
            ...
            >
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-violet-500 to-purple-600 mb-4 shadow-lg shadow-violet-500/30">
                ...
                <p className="text-gray-600">
                  Completa el formulario para reservar tu espacio
                </p>
              </div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-linear-to-r from-purple-600 to-violet-600 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
              </motion.button>
            </motion.form>
          )}
        </AnimatePresence>
