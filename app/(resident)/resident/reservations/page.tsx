...
const statusConfig = {
    APPROVED: {
        label: "Aprobada",
        className: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-500/30",
    },
    PENDING: {
        label: "Pendiente",
        className: "bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/30",
    },
    REJECTED: {
        label: "Rechazada",
            ...
            <div className="container max-w-7xl mx-auto px-4 py-8 md:py-12 space-y-8">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 mb-2">
                        ...
                        <span className="text-xs font-medium text-purple-600 dark:text-purple-400">Gestión de Amenities</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-purple-600">
                        Mis Reservas
                    </h1>
                    <p className="text-muted-foreground text-lg max-w-2xl">
                        Acá podés ver y gestionar todas tus reservas de amenities del edificio
                    </p>
                </motion.div>
                        ...
                        <Card className="border-dashed border-2 bg-muted/30 backdrop-blur-sm">
                            <CardContent className="p-12 flex flex-col items-center gap-4 text-center">
                                ...
                                <div className="space-y-2">
                                    <p className="text-lg font-semibold">No tenés reservas todavía</p>
                                    <p className="text-muted-foreground max-w-sm">
                                        Cuando reserves un amenity, va a aparecer acá con todos los detalles
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                                    ...
                                    <CardContent className="relative p-6 space-y-5">
                                        ...
                                        <div className="flex items-start justify-between gap-3">
                                            <div className="flex items-center gap-3 flex-1 min-w-0">
                                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-purple-500/20 group-hover:scale-110 transition-transform duration-300">
                                                    <Home className="w-6 h-6 text-white" />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-base font-semibold truncate">{reservation.amenityName}</p>
                                                    <p className="text-xs text-muted-foreground">Amenity</p>
                                                </div>
                                            </div>
                                            <Badge
                                                variant="outline"
                                                className={`${statusConfig[reservation.status].className} text-xs font-medium px-2.5 py-1 flex-shrink-0`}
                                            >
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-3 text-sm group/item">
                                                <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center flex-shrink-0 group-hover/item:bg-purple-500/10 transition-colors">
                                        ...
                                        {/* Indicador de hover */}
                                        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-purple-600 to-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
                                    </CardContent>
                                </Card>
                            </motion.div>
                        ))}
