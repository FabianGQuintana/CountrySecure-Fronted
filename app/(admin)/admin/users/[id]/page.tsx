      ...
      <div className="min-h-screen bg-linear-to-br from-purple-50/80 via-white/90 to-pink-50/80 p-4 md:p-8">
        <div className="max-w-6xl mx-auto">
          <div className="animate-pulse">
            <div className="h-8 w-48 bg-linear-to-r from-purple-200 to-violet-200 rounded-lg mb-6"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-purple-100/50 overflow-hidden">
              <div className="bg-linear-to-r from-purple-50/80 via-violet-50/80 to-pink-50/80 px-6 py-4 border-b border-purple-200/50">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="bg-linear-to-r from-purple-50/90 via-violet-50/90 to-pink-50/90 p-4 rounded-xl border border-purple-200/30">
                    ...
                    <div className="bg-linear-to-r from-fuchsia-50/90 via-pink-50/90 to-rose-50/90 p-4 rounded-xl border border-fuchsia-200/30">
                      <div className="flex items-center mb-2">
                        <div className="p-2 bg-linear-to-r from-fuchsia-100 to-pink-100 rounded-lg mr-3">
                  ...
                  <div className="space-y-4">
                    <div className="bg-linear-to-r from-amber-50/90 via-orange-50/90 to-yellow-50/90 p-4 rounded-xl border border-amber-200/30">
                      <div className="flex items-center mb-2">
                        <div className="p-2 bg-linear-to-r from-amber-100 to-orange-100 rounded-lg mr-3">
                    ...
                    <div className="bg-linear-to-r from-emerald-50/90 via-teal-50/90 to-cyan-50/90 p-4 rounded-xl border border-emerald-200/30">
                      <div className="flex items-center mb-2">
                        <div className="p-2 bg-linear-to-r from-emerald-100 to-teal-100 rounded-lg mr-3">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full p-4 bg-linear-to-r from-purple-50/80 via-violet-50/80 to-pink-50/80 border border-purple-300/50 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all appearance-none cursor-pointer"
                        required
                      >
                      ...
                      <div
                        className={`p-4 rounded-xl border-2 transition-all cursor-pointer ${
                          formData.role === "Resident"
                            ? "border-purple-500 bg-linear-to-r from-purple-50/80 via-violet-50/80 to-pink-50/80"
                        ...
                        <div className="flex items-center">
                          <div
                            className={`p-3 rounded-lg mr-4 ${
                              formData.role === "Resident"
                                ? "bg-linear-to-r from-purple-100 to-violet-100"
                                : "bg-linear-to-r from-purple-50/80 via-violet-50/80 to-pink-50/80"
                            }`}
                          >
                            <FiHome
                              className={`w-6 h-6 ${
                      ...
                      <div
                        className={`p-4 rounded-xl border-2 transition-all cursor-pointer ${
                          formData.role === "Security"
                            ? "border-violet-500 bg-linear-to-r from-violet-50/80 via-indigo-50/80 to-purple-50/80"
                          ...
                          <div
                            className={`p-3 rounded-lg mr-4 ${
                              formData.role === "Security"
                                ...
                                : "bg-linear-to-r from-violet-50/80 via-indigo-50/80 to-purple-50/80"
                            }`}
                          >
                            <FiShield
                              className={`w-6 h-6 ${
                  ...
                  <div className="pt-4 border-t border-purple-200/50">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      type="submit"
                      className="w-full py-4 bg-linear-to-r from-purple-600 via-violet-600 to-pink-500 text-white rounded-xl font-semibold hover:shadow-xl transition-all duration-300 flex items-center justify-center"
                    >
              ...
              <div className="p-6">
                  ...
                  <div className="relative inline-block mb-4">
                    <div
                      className={`w-24 h-24 rounded-full flex items-center justify-center ${
                        estadoUsuario
                          ? "bg-linear-to-r from-emerald-100 via-teal-100 to-cyan-100"
                          : "bg-linear-to-r from-rose-100 via-pink-100 to-red-100"
                      }`}
                    >
                      {estadoUsuario ? (
                    ...
                    <div
                      className={`absolute -bottom-2 -right-2 w-10 h-10 rounded-full flex items-center justify-center ${
                        estadoUsuario
                          ? "bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-400"
                          : "bg-linear-to-r from-rose-500 via-pink-500 to-red-400"
                      }`}
                    >
                      {estadoUsuario ? (
                ...
                <motion.button
                  ...
                  className={`w-full py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center ${
                    estadoUsuario
                      ? "bg-linear-to-r from-rose-500 via-pink-500 to-red-400 text-white hover:shadow-xl hover:from-rose-600 hover:via-pink-600 hover:to-red-500"
                      : "bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-400 text-white hover:shadow-xl hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-500"
                  }`}
                >
                  {isChangingStatus ? (
                    <div className="flex items-center">
                ...
                <div className="mt-6 p-4 bg-linear-to-r from-purple-50/80 via-violet-50/80 to-pink-50/80 rounded-xl border border-purple-200/30">
