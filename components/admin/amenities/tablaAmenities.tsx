  ...
  return (
    <div className="w-full h-max bg-linear-to-br from-purple-50/80 via-white/90 to-pink-50/80 min-h-screen p-4 sm:p-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-2 h-8 bg-linear-to-b from-purple-600 via-violet-600 to-pink-500 rounded-full"></div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
            {/* Selector de vista */}
            <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-lg border border-purple-200/50 p-1">
              <button
            ...
            <div className="relative w-full sm:w-64">
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FiSearch className="h-4 w-4 text-purple-400" />
                </div>
                <BuscadorTablas
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <button className="p-2 hover:bg-purple-50/50 rounded-lg transition-colors duration-200">
                        <FiMoreVertical className="w-5 h-5 text-purple-400" />
                      </button>
                    </div>
                    ...
                    {/* Botones de acción */}
                    <div className="mt-6 pt-5 border-t border-purple-200/50 flex justify-center">
                      <Link
                        href={`/admin/amenities/${amenity.id}/`}
                        className="flex items-center text-violet-600 hover:text-violet-900 transition-colors p-1 rounded-full hover:bg-violet-50/50"
                        title="Ver detalles"
                      >
              ...
              <thead className="bg-linear-to-r from-purple-50/80 via-violet-50/80 to-pink-50/80">
                <tr>
                  {[
                    ...
                    <th
                      key={col}
                      className="px-6 py-4 text-left text-xs font-semibold text-purple-700 uppercase tracking-wider cursor-pointer hover:bg-purple-100/50 transition-all duration-200 group"
                      onClick={() =>
      ...
      {amenitiesFiltradas.length > 0 && (
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-purple-100/50 px-6 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <p className="text-sm text-purple-600 mb-4 sm:mb-0">
              Mostrando{" "}
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="p-2 rounded-lg border border-purple-300/50 hover:bg-purple-50/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                <FiChevronUp className="transform rotate-90 h-4 w-4 text-purple-600" />
              </button>
