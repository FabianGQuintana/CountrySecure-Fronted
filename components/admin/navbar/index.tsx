...
// //       <div
// //         ref={menuRef}
// //         className={`fixed inset-y-0 left-0 z-40 w-64 h-screen bg-gradient-to-b from-gray-900 to-white p-6 flex flex-col justify-between shadow-xl border-r border-gray-100 transform transition-transform duration-300 ${
// //           isMobileMenuOpen
// //             ? "translate-x-0"
...
//       <div
//         ref={menuRef}
//         // className={`fixed inset-y-0 left-0 z-40 w-64 h-screen bg-gradient-to-b from-gray-900 to-gray-600 p-6 flex flex-col justify-between shadow-xl border-r border-gray-700 transform transition-transform duration-300 ${
//         className={`fixed inset-y-0 left-0 z-40 w-64 h-screen bg-gradient-to-b from-gray-100 to-gray-50 p-6 flex flex-col justify-between shadow-xl border-r border-gray-700 transform transition-transform duration-300 ${
//           isMobileMenuOpen
//             ? "translate-x-0"
//             : "-translate-x-full lg:translate-x-0"
//         }`}
...
//                     }
//                   />
//                   <span className="text-gray-50 font-medium">Usuarios</span>
//                 </div>
//                 {openSubMenu === "usuarios" ? (
...
//                     }
//                   />
//                   <span className="text-gray-50 font-medium">Amenities</span>
//                 </div>
//                 {openSubMenu === "amenities" ? (
//                   <ChevronUp size={18} className="text-gray-50" />
//                 ) : (
...
//                     }
//                   />
//                   <span className="text-gray-50 font-medium">Servicios</span>
//                 </div>
//                 {openSubMenu === "servicios" ? (
//                   <ChevronUp size={18} className="text-gray-50" />
//                 ) : (
