      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-fuchsia-500 to-orange-500 shadow-lg shadow-fuchsia-500/20">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-300">Enlaces Rápidos</h4>
            <ul className="space-y-2">
              {["Seguridad", "Amenities", "Comunidad", "Contacto"].map((link) => (
                <li key={link}>
                  <a
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-300">Contacto</h4>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="group flex h-10 w-10 items-center justify-center rounded-lg bg-gray-800/50 backdrop-blur-sm transition-all hover:bg-gradient-to-br hover:from-fuchsia-500 hover:to-orange-500 hover:shadow-lg hover:shadow-fuchsia-500/20"
                >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-800 pt-8 text-center md:flex-row md:text-left">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} CountryClub. Todos los derechos reservados.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-sm text-gray-400 transition-colors hover:text-fuchsia-400">
              Privacidad
            </a>
            <a href="#" className="text-sm text-gray-400 transition-colors hover:text-fuchsia-400">
              Términos
