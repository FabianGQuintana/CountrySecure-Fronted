...
const Security = () => {
  return (
    <section
      id="seguridad"
      className="py-20 bg-gradient-to-br from-sky-50 via-white to-purple-50 relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-purple-500 to-orange-500 rounded-full mb-6 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300 hover:scale-110">
            ...
            <div className="relative h-64 overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="flex items-center space-x-3 mb-2">
                  <div className="p-2 bg-gradient-to-br from-purple-500 to-orange-500 rounded-lg shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  <div className="shrink-0 p-3 bg-gradient-to-br from-purple-100 to-orange-100 rounded-lg group-hover:scale-110 transition-transform duration-300 border border-purple-200">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <Card className="relative overflow-hidden shadow-2xl animate-scale-in border-0 bg-gradient-to-br from-purple-500 via-purple-600 to-orange-500 p-[2px]">
            <div className="bg-white/95 backdrop-blur-xl rounded-lg p-8 md:p-12 relative">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-orange-500 rounded-full shadow-lg shadow-purple-500/30 mb-4">
                  <Shield className="h-8 w-8 text-white" />
                </div>
                <h3 className="text-3xl font-bold mb-4 bg-gradient-to-r from-purple-600 to-orange-500 bg-clip-text text-transparent">
                ...
                <div className="flex flex-wrap justify-center gap-8 text-center mt-8">
                  <div className="group hover:scale-110 transition-transform duration-300">
                    <div className="text-3xl font-bold bg-gradient-to-br from-purple-600 to-orange-500 bg-clip-text text-transparent mb-1">
                      24/7
                    </div>
