    ...
    >
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-purple-500 to-orange-500 rounded-full mb-6 shadow-lg shadow-purple-500/30 hover:scale-110 transition-all duration-300">
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <CardContent className="p-6">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-100 to-orange-100 rounded-xl mb-4 border border-purple-200 group-hover:scale-110 transition-transform">
          ...
          <Card className="relative overflow-hidden shadow-2xl animate-scale-in border-0 bg-gradient-to-br from-purple-500 via-purple-600 to-orange-500 p-[2px]">
            <div className="bg-white/95 backdrop-blur-xl rounded-lg p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-orange-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-purple-500/40 transition-all">
